...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $resultado = $cardapioController->excluir($_POST['id']);

    if ($resultado) {
        echo "<p>item excluida com sucesso!</p>";
        header("Location: cardapio_funcionario.php");
    } else {
        echo "<p>Erro ao excluir esse item. Tente novamente.</p>";
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/funcionario/cardapio/cardapio_funcionario.css">
...
<body>
    ...
    <section>
        <a href="adicionar_cardapio.php"><button class="botao-verde">Adicionar</button></a>
    </section>
    ...
    <?php foreach ($items as $item): ?>
        <div class="div-cardapio">
            <form method="POST" action="">
                ...
                <a href="editar_cardapio.php?id=<?php echo $item['id']; ?>&nome=<?php echo urlencode($item['nome']); ?>&preco=<?php echo urlencode($item['preco']); ?>" class="botao-branco">Editar</a>
