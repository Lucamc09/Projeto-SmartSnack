...
<head>
    ...
    <link rel="stylesheet" href="../../../style/funcionario/home/home_funcionario.css">
...
<body>
    ...
    <section>
        <div class="section-perfil">
            <span class="span-titulo">Um lugar para chamar de seu!</span>
            <hr>
            <span class="span-mensagem">O site de sua cantina favorita e feito especialamente para você. </span>
            <button class="botao-verde">Perfil</button>
        </div>
        <div class="section-perfil2">
            <img class="img-direita" src="https://images.unsplash.com/photo-1613482084286-41f25b486fa2?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
        </div>
    </section>
    <section>
        <div class="section-cardapio2">
            <img class="img-esquerda" src="https://images.unsplash.com/photo-1629341948402-42a2d20577a6?q=80&w=1462&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
        </div>
        <div class="section-cardapio">
            <span class="span-titulo">Descubra o sabor da felicidade!</span>
            <hr>
            <span class="span-mensagem">Um cardápio cheio de sabores e de diversidade para atender todos os desejos. </span>
            <button class="botao-verde">Cardapio</button>
        </div>
    </section>
    <section>
        <div class="section-contato">
            <span class="span-titulo">Seu sorriso, nossa prioridade!</span>
            <hr>
            <span class="span-mensagem">Para casos de críticas ou problemas você sempre poderá nos contatar.</span>
            <div class="num-contato">
                <svg class="svg-verde" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg> <span>4444-4444</span>
            </div>
        </div>
        <div class="section-contato2">
            <img class="img-direita" src="https://plus.unsplash.com/premium_photo-1663040118389-f0de2e6529a4?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
        </div>
    </section>
</body>
</html>