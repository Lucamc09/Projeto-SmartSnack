...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['titulo']) && isset($_POST['descricao'])) {
        ...
        $resultado = $novidadeController->adicionar($_POST['titulo'], $_POST['descricao']);

        if ($resultado) {
            echo "<p>Novidade adicionada com sucesso!</p>";
            header ('Location: novidade_funcionario.php');
        } else {
            echo "<p>Erro ao adicionar a novidade. Tente novamente.</p>";
        }
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/funcionario/novidade/novidade_adicionar.css">
...
<body>
    ...
    <section class="section-form">
        <div class="div-form">
            ...
            <form class="form-novidade" method="post" action="">
                ...
                <nav class="nav-form">
                    <button class="botao-verde" type="submit">Adicionar</button>
                </nav>
            </form>
        </div>
    </section>
