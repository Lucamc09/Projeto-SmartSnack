...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['email']) && isset($_POST['senha'])) {
        ...
        $resultado = $LoginController->autenticar('funcionario');
        // Verificar o resultado da operação
        if ($resultado) {
            // Redirecionar para a página do carrinho
            header('Location: ../home/home_funcionario.php');
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/funcionario/login/login_funcionario.css">
