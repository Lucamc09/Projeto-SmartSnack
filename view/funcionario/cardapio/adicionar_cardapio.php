...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Verifique se os campos 'nome' e 'preco' estão definidos
    if (isset($_POST['nome']) && isset($_POST['preco'])) {
        ...
        $resultado = $cardapioController->adicionar($_POST['nome'], $_POST['preco']);
...
<head>
    ...
    <link rel="stylesheet" href="../../../style/funcionario/cardapio/adicionar_cardapio.css">
